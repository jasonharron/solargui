...
//import { resetFunction } from './script.js';
...
class DragControls extends Controls {
  ...
  getRaycaster() {
    console.warn(
      "THREE.DragControls: getRaycaster() has been deprecated. Use controls.raycaster instead."
    ); // @deprecated r169
  ...
  setObjects(objects) {
    console.warn(
      "THREE.DragControls: setObjects() has been deprecated. Use controls.objects instead."
    ); // @deprecated r169
  ...
  getObjects() {
    console.warn(
      "THREE.DragControls: getObjects() has been deprecated. Use controls.objects instead."
    ); // @deprecated r169
  ...
  activate() {
    console.warn(
      "THREE.DragControls: activate() has been renamed to connect()."
    ); // @deprecated r169
    this.connect();
  }
  ...
  deactivate() {
    console.warn(
      "THREE.DragControls: deactivate() has been renamed to disconnect()."
    ); // @deprecated r169
    this.disconnect();
  }
...
function onPointerDown(event) {
  ...
  if (_intersections.length > 0) {
    if (_intersections[0].object.name == "reset") {
      console.log("Reset");
      resetFunction();
return;
    }
